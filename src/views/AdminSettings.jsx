...
export default function AdminSettings() {
  ...
  return (
    <div className="container-padding animate-fade-in" style={{ display: 'flex', flexDirection: 'column', gap: '2rem' }}>
      ...
      {/* Mandal and karyakar management moved to its own screen.

          The panels that used to live here wrote master data through the raw
          setSabhas/setKaryakars setters, bypassing the Admin permission check
          that addLookupEntries enforces — and delete was a single unconfirmed
          click that silently orphaned every balak in the mandal. Every mutation
          now goes through a guarded context action instead. */}
      <div className="glass-panel" style={{ padding: '1.5rem', borderRadius: 'var(--radius-md)', display: 'flex', justifyContent: 'space-between', alignItems: 'center', gap: '1rem', flexWrap: 'wrap' }}>
        <div style={{ flex: '1 1 300px' }}>
          <h3 style={{ fontSize: '1.15rem', display: 'flex', alignItems: 'center', gap: '0.5rem', marginBottom: '0.4rem' }}>
            <Layers size={18} color="var(--accent)" />
            <span>Mandals &amp; Karyakars</span>
          </h3>
          <p style={{ color: 'var(--text-secondary)', fontSize: '0.85rem', margin: 0, lineHeight: 1.6 }}>
            Managed on their own screen now, with rename, merge, safe delete and per-mandal balak counts.
            Open <strong>Mandals &amp; Karyakars</strong> in the navigation.
          </p>
        </div>
      </div>
